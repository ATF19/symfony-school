...
class appDevDebugProjectContainer extends Container
{
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => NULL, 'dbname' => 'Myschool', 'user' => 'root', 'password' => 'root', 'charset' => 'UTF8', 'driverOptions' => array(), 'defaultTableOptions' => array()), $b, new \Symfony\Bridge\Doctrine\ContainerAwareEventManager($this), array());
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $a->addDriver(new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($this->get('annotation_reader'), array(0 => ($this->targetDirs[3].'/src/My/schoolBundle/Entity'))), 'My\\schoolBundle\\Entity');

        $b = new \Doctrine\ORM\Configuration();
        $b->setEntityNamespaces(array('MyschoolBundle' => 'My\\schoolBundle\\Entity'));
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_2fdfc3771824d0d7092dd6163a16ed75701129468baac9a14b29657858658ee2');
    ...
    {
        $this->services['easyadmin.config.manager'] = $instance = new \EasyCorp\Bundle\EasyAdminBundle\Configuration\ConfigManager($this->get('easyadmin.cache.manager'), $this->get('property_accessor'), array('site_name' => 'MySchool Admin', 'entities' => array('User' => array('class' => 'My\\schoolBundle\\Entity\\User', 'list' => array('title' => 'Utilisateurs', 'actions' => array(0 => array('name' => 'search', 'label' => 'Recherche'), 1 => array('name' => 'new', 'label' => 'Ajouter'), 2 => array('name' => 'edit', 'label' => 'Modifier'), 3 => array('name' => 'delete', 'label' => 'Supprimer'))), 'name' => 'User'), 'Classe' => array('class' => 'My\\schoolBundle\\Entity\\Classe', 'list' => array('title' => 'Classe', 'actions' => array(0 => array('name' => 'search', 'label' => 'Recherche'), 1 => array('name' => 'new', 'label' => 'Ajouter'), 2 => array('name' => 'edit', 'label' => 'Modifier'), 3 => array('name' => 'delete', 'label' => 'Supprimer'))), 'name' => 'Classe'), 'Coefficient' => array('class' => 'My\\schoolBundle\\Entity\\Coefficient', 'list' => array('title' => 'Coefficient', 'actions' => array(0 => array('name' => 'search', 'label' => 'Recherche'), 1 => array('name' => 'new', 'label' => 'Ajouter'), 2 => array('name' => 'edit', 'label' => 'Modifier'), 3 => array('name' => 'delete', 'label' => 'Supprimer'))), 'name' => 'Coefficient'), 'Enseignant' => array('class' => 'My\\schoolBundle\\Entity\\Enseignant', 'list' => array('title' => 'Enseignant', 'actions' => array(0 => array('name' => 'search', 'label' => 'Recherche'), 1 => array('name' => 'new', 'label' => 'Ajouter'), 2 => array('name' => 'edit', 'label' => 'Modifier'), 3 => array('name' => 'delete', 'label' => 'Supprimer'))), 'name' => 'Enseignant'), 'Matiere' => array('class' => 'My\\schoolBundle\\Entity\\Matiere', 'list' => array('title' => 'Matiere', 'actions' => array(0 => array('name' => 'search', 'label' => 'Recherche'), 1 => array('name' => 'new', 'label' => 'Ajouter'), 2 => array('name' => 'edit', 'label' => 'Modifier'), 3 => array('name' => 'delete', 'label' => 'Supprimer'))), 'name' => 'Matiere'), 'Note' => array('class' => 'My\\schoolBundle\\Entity\\Note', 'list' => array('title' => 'Note', 'actions' => array(0 => array('name' => 'search', 'label' => 'Recherche'), 1 => array('name' => 'new', 'label' => 'Ajouter'), 2 => array('name' => 'edit', 'label' => 'Modifier'), 3 => array('name' => 'delete', 'label' => 'Supprimer'))), 'name' => 'Note'), 'Specialite' => array('class' => 'My\\schoolBundle\\Entity\\Specialite', 'list' => array('title' => 'Specialite', 'actions' => array(0 => array('name' => 'search', 'label' => 'Recherche'), 1 => array('name' => 'new', 'label' => 'Ajouter'), 2 => array('name' => 'edit', 'label' => 'Modifier'), 3 => array('name' => 'delete', 'label' => 'Supprimer'))), 'Student' => array('class' => 'My\\schoolBundle\\Entity\\Student', 'list' => array('title' => 'Etudiant', 'actions' => array(0 => array('name' => 'search', 'label' => 'Recherche'), 1 => array('name' => 'new', 'label' => 'Ajouter'), 2 => array('name' => 'edit', 'label' => 'Modifier'), 3 => array('name' => 'delete', 'label' => 'Supprimer')))), 'name' => 'Specialite')), 'design' => array('assets' => array('css' => array(), 'js' => array(), 'favicon' => array('path' => 'favicon.ico', 'mime_type' => 'image/x-icon')), 'theme' => 'default', 'color_scheme' => 'dark', 'brand_color' => '#205081', 'form_theme' => array(0 => '@EasyAdmin/form/bootstrap_3_horizontal_layout.html.twig'), 'menu' => array()), 'formats' => array('date' => 'Y-m-d', 'time' => 'H:i:s', 'datetime' => 'F j, Y H:i'), 'disabled_actions' => array(), 'translation_domain' => 'messages', 'list' => array('actions' => array(), 'max_results' => 15), 'search' => array(), 'edit' => array('actions' => array()), 'new' => array('actions' => array()), 'show' => array('actions' => array(), 'max_results' => 10)), true);
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'/src/My/schoolBundle/Resources/views'), 'Myschool');
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'MyschoolBundle' => 'My\\schoolBundle\\MyschoolBundle',
            ...
            'easyadmin.config' => array(
                'site_name' => 'MySchool Admin',
                'entities' => array(
                    'User' => array(
                        'class' => 'My\\schoolBundle\\Entity\\User',
                        'list' => array(
                            'title' => 'Utilisateurs',
                            'actions' => array(
                                0 => array(
                    ...
                    'Classe' => array(
                        'class' => 'My\\schoolBundle\\Entity\\Classe',
                        'list' => array(
                            'title' => 'Classe',
                            'actions' => array(
                                0 => array(
                    ...
                    'Coefficient' => array(
                        'class' => 'My\\schoolBundle\\Entity\\Coefficient',
                        'list' => array(
                            'title' => 'Coefficient',
                            'actions' => array(
                                0 => array(
                    ...
                    'Enseignant' => array(
                        'class' => 'My\\schoolBundle\\Entity\\Enseignant',
                        'list' => array(
                            'title' => 'Enseignant',
                            'actions' => array(
                                0 => array(
                    ...
                    'Matiere' => array(
                        'class' => 'My\\schoolBundle\\Entity\\Matiere',
                        'list' => array(
                            'title' => 'Matiere',
                            'actions' => array(
                                0 => array(
                    ...
                    'Note' => array(
                        'class' => 'My\\schoolBundle\\Entity\\Note',
                        'list' => array(
                            'title' => 'Note',
                            'actions' => array(
                                0 => array(
                    ...
                    'Specialite' => array(
                        'class' => 'My\\schoolBundle\\Entity\\Specialite',
                        'list' => array(
                            'title' => 'Specialite',
                            'actions' => array(
                                0 => array(
                        ...
                        'Student' => array(
                            'class' => 'My\\schoolBundle\\Entity\\Student',
                            'list' => array(
                                'title' => 'Etudiant',
                                'actions' => array(
                                    0 => array(
